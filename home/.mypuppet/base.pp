class base {
    $basepackages = [
      ...
      'mysql-server', 'mpg321', 'mc', 'mercurial', 'moreutils', 'mcollective-client', 'most',
      ...
      'quicksynergy',
      'rubygems', 'ri-li',
      's3cmd', 'sabnzbdplus', 'sawfish', 'subversion', 'synaptic', 'sysstat', 'sauerbraten', 'supertuxkart', 'shutter', 'samba', 'soundconverter',
